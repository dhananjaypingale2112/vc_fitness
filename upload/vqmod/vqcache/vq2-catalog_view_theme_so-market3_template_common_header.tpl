...
<div id="wrapper" class="<?php echo $cls_wrapper; ?>">
	...
	<header id="header" class="<?php echo ((!empty($soconfig_bgall) || !empty($soconfig_general["bgall"])) && isset($soconfig_general['bg_image_status']) && $soconfig_general['bg_image_status'] == 1 ? 'boxed_bg' : ''); ?> variant<?php echo $header_type; ?>">
	   
		<!-- Header Top -->
		<section class="header-top compact-hidden">
			<div class="container">
				<div class="row">
					<div class="header-top-left form-inline col-sm-5 ">
						
						<?php if($soconfig_general["welcome_message_status"]):?>
						<div class="form-group navbar-welcome hidden-xs" style="padding:5px 0;">
							<?php
					...
					<div class="header-top-right collapsed-block col-md-7 col-sm-12 ">
					   ...
					   <?php if (!isset($soconfig_general["header_account"]) || $soconfig_general["header_account"] ) : ?>
						...
						<ul class="top-link list-inline">
							...
							<?php if($soconfig_general["wishlist_status"]):?><li class="wishlist"><a href="<?php echo $wishlist; ?>" id="wishlist-total" class="top-link-wishlist" title="<?php echo $text_wishlist; ?>"><?php echo $text_wishlist; ?></a></li><?php endif; ?>
				   ...
				   <div class="shopping_cart pull-right">
					...
					if($soconfig_general['phone_status']){
						if (isset($soconfig_general[$lang]["contact_number"]) && is_string($soconfig_general[$lang]["contact_number"])) {
						 echo '<div class="phone-contact hidden-xs"><div class="inner-info"><strong>'. $text_phone.'</strong><p>Toll free: '.html_entity_decode($soconfig_general[$lang]["contact_number"], ENT_QUOTES, 'UTF-8').'</p></div></div>';
						} 
					}
					?>
					</div>
		...
		<section class="header-bottom">
			...
			<div class="row">
				...
				<div class="header-bottom-right  col-md-12 col-sm-12 col-xs-12">
				    <div class="navbar-menu col-md-8 col-sm-6 col-xs-6">
				...
				<div class="header-seach col-md-4 col-sm-6 col-xs-6">
				   <!-- Search -->
