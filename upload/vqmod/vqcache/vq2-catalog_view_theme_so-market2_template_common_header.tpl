...
<?php // Begin Themes Scripts ----?>
	...
	foreach ($soconfig_jsfile as $file_js) { ?>
		<script   gatype="text/javascript" src="<?php echo $file_js?>"></script>
	<?php } endif;?>
...
<div id="wrapper" class="<?php echo $cls_wrapper; ?>">
	...
	<header id="header" class=" variant<?php echo $header_type; ?>">
		...
		<section class="header-top compact-hidden">
			<div class="container">
				<div class="row">
					<div class="header-top-left form-inline col-lg-6 col-md-5 col-sm-6 ">
						<?php
					...
					<div class="header-top-right collapsed-block col-lg-6 col-md-7 col-sm-12 ">
		...
		<section class="header-center <?php echo $header_type;?>">
			<div class="container">
			   ...
			   <?php if ($header_type == 'center') { ?>
					<!-- Search -->
					<?php //echo $search; ?>
					<div class="navbar-logo col-sm-12 col-xs-12 text-center">
						<?php if ($logo) { ?>
			   ...
			   <!--end header variant center-->
				...
				<div class="navbar-menu col-lg-7 col-md-6 col-sm-8 col-xs-6">
		...
		<section class="header-bottom">
			<div class="container">
			 <div class="row">
				...
				<div class="header-bottom-right <?php  echo (isset($str) && !empty($str)) ? ' col-md-9 col-sm-8 col-xs-12 ' : 'col-xs-12' ;?>">
					<!-- Search -->
