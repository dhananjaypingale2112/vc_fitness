...
<script src="catalog/view/theme/so-market/js/jquery.bpopup.min.js"></script>
	
	<div id="element_to_pop_up">
		<a class="b-close">X</a>
		<!--<span id="pincode_error" style="color:red;display:none;">
		</span><span id="pincode_success" style="color:green;display:none;"></span><br/>
		pincode :<input type="text" id="pincode" name="pincode">
		<input type="button" id="check_pincode" value="Submit"> -->
		<div class="uiv2_modal">
	        <div class="uiv2_bb_logo" style="background-color: white;padding: 12px 20px;position: absolute;left: 93px;top: -48px;border-top-right-radius: 6px;border-top-left-radius: 6px;">
	            <img src="image/catalog/VSB_OK.png" alt="bbLogo">
	        </div>
	        <div class="uiv2_inner-content">
	            <div class="uiv2_left_content" style="border: 1px solid #ededed;border-radius: 5px;padding: 13px 13px 32px 13px;text-align: center;margin-top: 16px;">
	                <span id="pincode_error" style="color:red;display:none;"></span>
	                <span id="pincode_success" style="color:green;display:none;"></span><br/>
	                <label style="font-size: 14px;">Enter Pincode <br></label>
	                <div>
						<input type="text" id="pincode" name="pincode" style="">
					</div>
					<div>
						<input type="button" id="check_pincode" value="Submit">
					</div>
