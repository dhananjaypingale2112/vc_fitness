...
<div id="wrapper" class="<?php echo $cls_wrapper; ?>">
	...
	<header id="header" class=" variant<?php echo $header_type; ?>">
			...
			<div class="container">
				<div class="row">
					<div class="header-top-left col-md-8 col-sm-6">
						...
						<div class="col-md-6 col-sm-12 navbar-welcome hidden-xs">
							<?php
						...
						if($soconfig_general['phone_status']){
							if (isset($soconfig_general[$lang]["contact_number"]) && is_string($soconfig_general[$lang]["contact_number"])) {
							 echo '<div class="col-sm-6 navbar-phone hidden-sm hidden-xs" > '.$text_phone.' <b>'.html_entity_decode($soconfig_general[$lang]["contact_number"], ENT_QUOTES, 'UTF-8').'</b></div>';
							} 
						}
						?>
					 ...
					 <?php if (!isset($soconfig_general["header_account"]) || $soconfig_general["header_account"] ) : ?>
						...
						<ul class="top-link list-inline">
							<li class="account" id="my_account"><a href="<?php echo $account; ?>" title="<?php echo $text_account; ?>" class="btn btn-xs dropdown-toggle" data-toggle="dropdown"> <span><?php echo $text_account; ?></span> <span class="fa fa-angle-down"></span></a>
							 ...
							 <li class="login"><a href="<?php echo $shopping_cart; ?>" title="<?php echo $text_shopping_cart; ?>"><span ><?php echo $text_shopping_cart; ?></span></a></li>
							<?php if($soconfig_general["checkout_status"]):?><li class="checkout"><a href="<?php echo $checkout; ?>" class="top-link-checkout" title="<?php echo $text_checkout; ?>"><?php echo $text_checkout; ?></a></li><?php endif; ?>
						</ul>
		...
		<section class="header-center <?php echo $header_type;?>">
			<div class="container">
			    ...
			    <?php if ($header_type == 'center') { ?>
					...
					<div class="navbar-logo col-sm-12 text-center">
						<?php if ($logo) { ?>
				...
				<div class="header-center-right col-md-9 col-sm-8 col-xs-12 compact-hidden">
				    ...
				    <?php endif; ?>
				    <ul class="links">
					   <?php if($soconfig_general["wishlist_status"]):?><li class="wishlist"><a href="<?php echo $wishlist; ?>" id="wishlist-total" class="top-link-wishlist" title="<?php echo $text_wishlist; ?>"><?php //echo $text_wishlist; ?> <i class="fa fa-heart"></i> </a></li><?php endif; ?>
					   <li class="wishlist"><a href="index.php?route=product/compare" id="comapre-total" class="top-link-wishlist" title="<?php echo $text_compare; ?>"><?php //echo $text_compare; ?> <i class="fa fa-bar-chart-o"></i></a></li>
				    </ul>
				</div>   
		...
		<section class="header-bottom">
			<div class="container">
			 <div class="row">
				 <?php if (isset($content_block1) && !empty($content_block1)): ?>
				 <div class="sidebar-menu col-md-3 col-sm-4 col-xs-12">
					<?php echo $content_block1; ?>
				 </div>
				 <?php endif ?>
				 <!-- Main menu -->
				 <div class="header-bottom-right <?php  echo (isset($content_block1) && !empty($content_block1)) ? ' col-md-9 col-sm-8 col-xs-12 ' : ' col-xs-12' ;?>">
				 <!-- Search -->
					<?php if ($soconfig_general['searchbox']) echo $content_search; ?>
					<!-- //end Search -->
