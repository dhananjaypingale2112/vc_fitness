...
<link rel="stylesheet" type="text/css" href="view/javascript/jquery/datetimepicker/bootstrap-datepicker.css">
<script type="text/javascript" src="view/javascript/jquery/datetimepicker/bootstrap-datepicker.js"></script>
  ...
  <ul class="nav pull-right">
    ...
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-life-ring fa-lg"></i></a>
      <ul class="dropdown-menu dropdown-menu-right">
        ...
        <li><a href="http://www.proxanttech.com" target="_blank"><?php echo $text_homepage; ?></a></li>
