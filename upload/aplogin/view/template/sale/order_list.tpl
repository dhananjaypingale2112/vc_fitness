      ...
      <div class="panel-body">
        ...
        <select name="filter_batch" id="input-batch" class="form-control">
            ...
            <div class="col-sm-4">
              ...
              <div class="form-group">
                <label class="control-label" for="input-batch">Shipping Date</label>
                <input type="text" name="filter_batch_date" value="<?php echo $filter_batch_date; ?>" class='form-control datetimepicker5'>
              </div>
            </div>
            <div class="col-sm-4">
              <div class="form-group">
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-right"><?php if ($sort == 'o.total') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-right">Shipping Time</td>
					        <td class="text-right">Shipping Date</td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><?php echo $order['batch_name']; ?></td>
				          <td class="text-right"><?php echo $order['batch_date']; ?></td>
...
$('#button-filter').on('click', function() {
  ...
  var filter_batch_date = $('input[name=\'filter_batch_date\']').val();

  if (filter_batch_date) {
    url += '&filter_batch_date=' + filter_batch_date;
  }
