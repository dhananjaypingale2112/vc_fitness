          ...
          <table class="table">
            <tbody>
              ...
              <tr>
                ...
                <td><?php echo $date_added."  On  ".$batch_name; ?></td>
              </tr>
              <tr>
          ...
          <div class="tab-pane active" id="tab-history">
            ...
            <fieldset>
              ...
              <form class="form-horizontal">
                ...
                <div class="form-group" id="delivery_per" style="display:none">
                  <label class="col-sm-2 control-label" for="input-comment">Delivery Person</label>
                  <div class="col-sm-5">
                    <input type="text" name="deiv_person" id="input-dev_person" class="form-control"/>
                  </div>
                </div>

                <div class="form-group" id="delivery_per_mob" style="display:none">
                  <label class="col-sm-2 control-label" for="input-comment">Delivery Person Mobile</label>
                  <div class="col-sm-5">
                    <input type="text" name="deiv_person_mob" id="input-dev_person_mob" class="form-control"/>
                  </div>
                </div>
...
$('#input-order-status').on('change', function() {
  var value = $('#input-order-status').val();
  if(value == 3) {
    $('#delivery_per').show();
    $('#delivery_per_mob').show();  
  } else{
    $('#delivery_per').hide();
    $('#delivery_per_mob').hide();
  }
