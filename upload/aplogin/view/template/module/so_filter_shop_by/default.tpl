		 ...
		 <div class="col-sm-4 sj_filter_shop_by_content_menu_type">
				...
				<div class="sj_wrap_border">
					<div class="sj_wrap">
						...
						<div class="bg-success sj_item_type_filter" data-type="field_chose"><div class="sj_move_type_filter">Field Checkbox</div><div class="sj_action_type_filter"><i class="fa fa-paper-plane-o"></i></div></div>
						<div class="bg-success sj_item_type_filter" data-type="field_select"><div class="sj_move_type_filter">Field Select</div><div class="sj_action_type_filter"><i class="fa fa-paper-plane-o"></i></div></div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		if(val_database != ''){
			...
			console.log(array_item_content.length);
			for(var i = 0; i < array_item_content.length; i++){
					...
					if(type == 'field_chose' || type == 'filed_radio' || type == 'field_select'){
					...
					for(var e = 0; e < array_e.length; e++){
							if(e == 0){
									...
									if(type == 'manufacturer'){
										var info_caregory = array_e[e].split('-');
										console.log(info_caregory[2]);
										if (info_caregory[2] != 'undefined')
											var img = info_caregory[2];
										else
											var img = '';
		...
		array_html_type['field_chose'] = '<div class="bg-success sj_filter_shop_by_content_menu_title_item" data-type="field_chose">'+
																	'<div class="sj_title_item"><p>Field Checkbox</p><input type="text" value="Field Chose"/></div>'+
																	'<div class="sj_action_item">'+
																	'<div class="sj_action_item_action sj_action_item_remove"><i class="fa fa-times"></i></div>'+
																	'<div class="sj_action_item_action sj_action_item_move"><i class="fa fa-arrows"></i></div>'+
																	'<div class="sj_action_item_action sj_action_item_edit"><i class="fa fa-pencil"></i></div>'+
																...
																'<div class="sj_filter_shop_by_content_menu_conten_item">'+
																	...
																	'</div>'+
																'</div>';
		array_html_type['field_select'] = '<div class="bg-success sj_filter_shop_by_content_menu_title_item" data-type="field_select">'+
																	'<div class="sj_title_item"><p>Field Select</p><input type="text" value="Field Select"/></div>'+
																	'<div class="sj_action_item">'+
																	'<div class="sj_action_item_action sj_action_item_remove"><i class="fa fa-times"></i></div>'+
																	'<div class="sj_action_item_action sj_action_item_move"><i class="fa fa-arrows"></i></div>'+
																	'<div class="sj_action_item_action sj_action_item_edit"><i class="fa fa-pencil"></i></div>'+
