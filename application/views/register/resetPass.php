            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2 text">
                        <h1> <strong> Reset Password!</h1>
                        <div class="description">
                       	    <p>
                                Please reset your password for better security..!
				...
				<div class="header-right w3agile">
					<div class="header-left-bottom agileinfo">
					 <form id="resetPassForm">
						<input type="password"  value="Password" name="password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}" id="password"/>
