...
<body>
	...
	<div class="wrapper">
        ...
        <tbody>
          <tr>
            <td class="text-left" style="width: 50%;">              <b>Order ID:</b> #101<br>
              <b>Date Added:</b> 01/03/2017</td>
            <td class="text-left">              <b>Payment Method:</b> Cash On Delivery<br>
                                          <b>Shipping Method:</b> Flat Shipping Rate                      <br>
                      <b>Shipping Time : </b> 11AM-2PM                      </td>
          </tr>
        </tbody>
      </table>
      <!-- order-detail end -->
      ...
      <table class="table table-bordered table-hover">
        ...
        <tbody>
          <tr>
            <td class="text-left">Rachita Sorate<br>jjjjj<br>jjjjj<br>jjj<br>jjjjj 400705<br>Maharashtra<br>India</td>
                        <td class="text-left">Rachita Sorate<br>jjjjj<br>jjjjj<br>jjj<br>jjjjj 400705<br>Maharashtra<br>India</td>
                      </tr>
        </tbody>
      </table>
       ...
       <div class="table-responsive">
        <table class="table table-bordered table-hover">
          ...
          <tbody>
                        <tr>
              <td class="text-left">Baby Corn-Peeled                                <br>
                &nbsp;<small> - Weight Selection: 1 Kg</small>
                </td>
              <td class="text-left">Baby Corn-Peeled</td>
              ...
              <td class="text-right" style="white-space: nowrap;">                <a href="#" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Reorder"><i class="fa fa-shopping-cart"></i></a>
                                <a href="product-return.html" data-toggle="tooltip" title="" class="btn btn-danger" data-original-title="Return"><i class="fa fa-reply"></i></a></td>
            </tr>
                        <tr>
              <td class="text-left">Carrot Grated                                <br>
                &nbsp;<small> - Weight Selection: 1 Kg</small>
                </td>
              <td class="text-left">Carrot Grated</td>
              <td class="text-right">1</td>
              ...
              <td class="text-right" style="white-space: nowrap;">                <a href="#" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Reorder"><i class="fa fa-shopping-cart"></i></a>
                        ...
                        <tr>
              <td class="text-left">Beetroot Diced                                <br>
                &nbsp;<small> - Weight Selection: 1 Kg</small>
                </td>
              <td class="text-left">Beetroot Diced</td>
              <td class="text-right">1</td>
              <td class="text-right">Rs.75.00/-</td>
              <td class="text-right">Rs.75.00/-</td>
              <td class="text-right" style="white-space: nowrap;">                <a href="#" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Reorder"><i class="fa fa-shopping-cart"></i></a>
                        ...
                        <tr>
              <td class="text-left">Diced Papaya                                <br>
                &nbsp;<small> - Weight Selection: 1 Kg</small>
                </td>
              <td class="text-left">Diced Papaya</td>
              <td class="text-right">1</td>
              <td class="text-right">Rs.115.00/-</td>
              <td class="text-right">Rs.115.00/-</td>
              <td class="text-right" style="white-space: nowrap;">                <a href="#" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Reorder"><i class="fa fa-shopping-cart"></i></a>
                                <a href="product-return.html" data-toggle="tooltip" title="" class="btn btn-danger" data-original-title="Return"><i class="fa fa-reply"></i></a></td>
            </tr>
          ...
          <tfoot>
              ...
              <td class="text-right">Rs.325.00/-</td>
                            <td></td>
                          </tr>
                        <tr>
              <td colspan="3"></td>
              ...
              <td class="text-right">Rs.345.00/-</td>
                            <td></td>
                          </tr>
                      </tfoot>
        </table>
