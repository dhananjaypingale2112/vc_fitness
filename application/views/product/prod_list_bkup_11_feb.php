                      ...
                      <div class="single-products">
                        <div class="productinfo text-center">
                          <img src="<?php echo base_url();?>public/images/products/product-low-res.png" alt="" />
                                                    <h2><?php echo $display_cnt; ?></h2>
                          <p><?php echo $newProduct[$i]['product_id']; ?></p>
                    ...
                    <div class="product-image-wrapper">
                      <div class="single-products">
                        <div class="productinfo text-center">
                          <img src="<?php echo base_url();?>public/images/products/product-low-res.png" alt="" />
                                                    <h2>$56</h2>
                          <p><?php echo $newProduct[$i+1]['product_id']; ?></p>
                          <a href="#" class="btn-cart" onclick="info('Product Added Successfully.')"><i class="fa fa-shopping-cart"></i>&nbsp;Add to cart</a>
                        </div>
                    ...
                    <div class="product-image-wrapper">
                      <div class="single-products">
                        <div class="productinfo text-center">
                          <img src="<?php echo base_url();?>public/images/products/product-low-res.png" alt="" />
                                                    <h2>$56</h2>
                          <p><?php echo $newProduct[$i+2]['product_id']; ?></p>
                          <a href="#" class="btn-cart" onclick="info('Product Added Successfully.')"><i class="fa fa-shopping-cart"></i>&nbsp;Add to cart</a>
                        </div>
                    ...
                    <div class="product-image-wrapper">
                      <div class="single-products">
                        <div class="productinfo text-center">
                          <img src="<?php echo base_url();?>public/images/products/product-low-res.png" alt="" />
                                                    <h2>$56</h2>
                          <p><?php echo $newProduct[$i+3]['product_id']; ?></p>
                          <a href="#" class="btn-cart" onclick="info('Product Added Successfully.')"><i class="fa fa-shopping-cart"></i>&nbsp;Add to cart</a>
                        </div>
